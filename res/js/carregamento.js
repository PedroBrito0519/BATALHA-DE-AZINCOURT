...
function showStory(storyIndex) {
    const titles = [
        "A Batalha de Azincourt - Parte 1",
        "A Batalha de Azincourt - Parte 2",
        "A Batalha de Azincourt - Parte 3"
    ];

    const texts = [
        "Em 25 de outubro de 1415, a Batalha de Azincourt foi um dos confrontos mais decisivos da Guerra dos Cem Anos. O exército inglês, liderado pelo rei Henrique V, estava em desvantagem numérica, mas sua estratégia e coragem mudaram o rumo da batalha.",
        "O exército francês, confiante em sua superioridade, atacou sem considerar as táticas do inimigo. O terreno lamacento e a chuva contribuíram para a desordem nas fileiras francesas, enquanto os arqueiros ingleses causaram estragos em suas linhas.",
        "A vitória dos ingleses em Azincourt não apenas consolidou a posição de Henrique V, mas também se tornou um símbolo de bravura e resistência. Esta batalha é lembrada como um marco na história militar, onde a estratégia superou a força bruta."
    ];
